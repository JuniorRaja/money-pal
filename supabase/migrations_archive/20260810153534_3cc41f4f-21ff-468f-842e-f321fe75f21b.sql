...
create policy currencies_read on public.currencies for select to authenticated, anon using (deleted_at is null);
create policy fx_rates_read on public.fx_rates for select to authenticated, anon using (deleted_at is null);
create policy budget_templates_read on public.budget_templates for select to authenticated, anon using (deleted_at is null);
...
create policy categories_read_anon on public.categories for select to anon
  using (deleted_at is null and user_id is null);
